...
namespace Kynda
{
    ...
    internal static class KyndaConfig
    {
        ...
        public static void Bind(ConfigFile config)
        {
            ...
            //
            // The prefab name is kynda_tun as of 2026-08-25, renamed from kynda_hopper
            ...
            // kynda_trough_casks, not kynda_trough_barrels. Same two casks on the same
            ...
            // kynda_rack_courses, not kynda_rack_lean. The lean-to's logs were built by
